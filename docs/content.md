# Nahor Homestay – Content Source

## Important Rule

Use only the information written in this file for the website content.
...
If any information is missing, write:
...
The website should help guests understand the rooms, pricing, amenities, location, house rules, and quickly book through WhatsApp or phone call.
...
WELCOME TO NAHOR HOMESTAY

## Main Heading

Your Comfortable Stay in Dibrugarh
...
Enjoy a clean, spacious, and comfortable homestay experience in Dibrugarh with 1BHK and 2BHK units, essential amenities, and easy booking support.
...
Nahor Homestay has 3 1BHK units.

## 1BHK Ground Floor

Room Type: 1BHK Non-AC
Floor: Ground Floor
Suitable For:
...
## 1BHK 3rd Floor AC Unit 1

Room Type: 1BHK AC 3rd Floor
Floor: 3rd Floor
Specification:
* AC Only (AC cannot be turned off)
* Description: A comfortable 1BHK stay on the 3rd floor with AC-only setup. Ideal for guests who prefer air-conditioned comfort throughout their stay.
Suitable For:
* Comfortable private stay
* Couples
* Small families
* Travellers

## 1BHK 3rd Floor AC Unit 2

Room Type: 1BHK AC / Non-AC 3rd Floor
Floor: 3rd Floor
Specification:
* AC / Non-AC option (AC can be turned on/off based on preference)
* Description: A flexible 1BHK stay on the 3rd floor where AC can be turned on or off based on preference. Suitable for guests who want both AC and Non-AC options.
Suitable For:
* Flexible comfort stay
* Couples
* Small families
* Travellers
...
Pricing must be shown clearly. Do not change the prices.
...
Lounge access: ₹500 extra

---

# 9. Amenities

Use these amenities only:
...
Stay connected with complimentary Wi-Fi during your stay.

## Parking

Parking space available for up to 5 cars.

## Geyser

Geyser facility available for a comfortable stay.

## RO Drinking Water

RO drinking water is available for guests.

## Separate Kitchen

Separate kitchen access available for convenience.

## Power Backup

24x7 power backup available.

## Private Balcony

Enjoy balcony access for a relaxed and peaceful stay.

## Lounge

Lounge access is available at ₹500 extra.
...
Any material damage to the property will be charged extra to the guest.

---

# 12. Room Section Titles

Use these titles for room cards:
...
Book your stay at Nahor Homestay and enjoy a peaceful, spacious, and comfortable stay in Dibrugarh.
...
Contact Nahor Homestay

## Contact Text

For bookings, room availability, and pricing details, contact Nahor Homestay directly.
...
Answer: Yes, 24x7 power backup is available.

## FAQ 7

Question: Is loud music allowed?
Answer: No loud music is allowed after 10:00 PM.

## FAQ 8

Question: How can I book a room?
Answer: Guests can book by calling or sending a WhatsApp message to +91 94017 09323.
...
Nahor Homestay offers comfortable 1BHK and 2BHK stays in Dibrugarh with essential amenities, peaceful rooms, balcony access, and easy booking support.
...
© Nahor Homestay. All rights reserved.
...
# 19. Final Content Rule

Every text used in the website must come from this `content.md` file.

Before writing website code, read:
...
If any information is missing, leave a TODO instead of inventing details.
